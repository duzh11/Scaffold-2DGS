...
if __name__ == '__main__':
    ...
    parser.add_argument('--exps', type=str, default='./logs/scene0050_00/20250723-155917')
    parser.add_argument('--mesh_idx', type=int, default=-1, help='index of mesh to evaluate')
    ...
    if args.mesh_idx == -1:
        ...
        mesh_pred = os.path.join(args.exps, f'mesh_{args.mesh_idx}.ply')
